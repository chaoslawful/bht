#ifndef CONFIG_UNIT_H_STUB	// 头文件保护宏，请根据实际的头文件名自行修改
#define CONFIG_UNIT_H_STUB	//

#include <cppunit/extensions/HelperMacros.h>
// 为了得到 timeval 结构和 gettimeofday() 函数的声明，以便输出每次测试的耗时
#include <sys/time.h>

class ConfigUnitTest/* 这里的单元测试类名必须在整个单元测试系统中唯一 */
	: public CPPUNIT_NS::TestFixture
{
	CPPUNIT_TEST_SUITE( ConfigUnitTest /* 这里是单元测试类名 */ );
	CPPUNIT_TEST( test /* 单个测试用例函数 */ );
